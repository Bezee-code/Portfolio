...
const heroEntranceAnimationCss = `
/* ==========================================================================
   EDITORIAL HERO ENTRANCE ANIMATION SYSTEM (STRIPE / LINEAR / VERCEL STYLE)
...
if (!cssContent.includes('EDITORIAL HERO ENTRANCE ANIMATION SYSTEM')) {
  cssContent += '\n' + heroEntranceAnimationCss;
  fs.writeFileSync(cssFile, cssContent, 'utf8');
  console.log('Appended hero entrance animation CSS to css/style.css!');
} else {
  const startPos = cssContent.indexOf('EDITORIAL HERO ENTRANCE ANIMATION SYSTEM');
  cssContent = cssContent.substring(0, startPos - 4) + heroEntranceAnimationCss;
  fs.writeFileSync(cssFile, cssContent, 'utf8');
  console.log('Updated hero entrance animation CSS in css/style.css!');
}

console.log('Successfully completed hero entrance animation integration!');
