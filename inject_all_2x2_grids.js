            ...
            <div class="pm-thinking-grid-section">
              ...
              <div class="pm-thinking-grid">
                ...
                <div class="thinking-card" style="border-color:var(--border-highlight);">
                  <div class="thinking-card-header">
                    <div class="thinking-card-icon" style="background:rgba(250,38,160,0.15); color:var(--firefly-pink);">⚖️</div>
...
// Insert for Adobe Firefly (Project 1)
const fireflyActionBtn = `<a href="firefly.html" class="btn btn-primary" style="background:linear-gradient(135deg, #FA26A0, #c084fc); color:white; font-weight:800; padding:0.85rem 1.65rem; font-size:0.95rem; text-decoration:none;">`;
if (content.includes(fireflyActionBtn) && !content.includes('Adobe Firefly Transcreate with LLM localization engine')) {
  const target = `<div class="pm-card-actions">\n              ${fireflyActionBtn}`;
  const replacement = `${fireflyGrid}\n\n            <div class="pm-card-actions">\n              ${fireflyActionBtn}`;
  content = content.replace(target, replacement);
  console.log('Injected 2x2 grid for Adobe Firefly!');
}
...
if (content.includes(stanzaActionBtn) && !content.includes('Stanza Care Vision AI Triage Engine')) {
  const target = `<div class="pm-card-actions">\n              ${stanzaActionBtn}`;
...
if (content.includes(orientActionBtn) && !content.includes('B2B SRN Automation Portal with mobile QR audit verification')) {
  const target = `<div class="pm-card-actions">\n              ${orientActionBtn}`;
...
if (content.includes(snapmintActionBtn) && !content.includes('Snapmint One-Click BNPL Checkout with sub-30sec')) {
  const target = `<div class="pm-card-actions">\n              ${snapmintActionBtn}`;
...
console.log('Updated index.html successfully with all 4 2x2 grids!');
