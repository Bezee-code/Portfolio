...
const DEFAULT_PORTFOLIO_DATA = {
  ...
  caseStudies: [
  {
    ...
    "impactBadges": [
      {
        "value": "48 Hours",
        "label": "Credit Settlement (down from 28d)"
      },
      {
        "value": "99.4%",
    ...
    "executionJourney": [
      {
        ...
        "subtitle": "Captured 28-day working capital lockup complaints"
      },
      {
        "step": "2",
        "icon": "🗺️",
        "title": "Process Mapping",
        "subtitle": "Documented paper SRN slip vulnerabilities & lost claims"
      },
      {
        "step": "3",
        "icon": "⚡",
        "title": "SAP Analysis",
        "subtitle": "Audited SAP ERP invoice history & BAPI endpoints"
      },
      {
        "step": "4",
        "icon": "📱",
        "title": "QR Workflow",
        "subtitle": "Created mobile serial barcode scanner intake UI"
      },
      {
        "step": "5",
        "icon": "🔗",
        "title": "API Integration",
        "subtitle": "Wired BAPI_ACC_DOCUMENT_POST credit note triggers"
      },
      {
        "step": "6",
        "icon": "🚀",
        "title": "Pilot Rollout",
        "subtitle": "Deployed across 4,000+ pan-India distributors"
      },
      {
        "step": "7",
        "icon": "💳",
        "title": "Credit Settlement",
        "subtitle": "Slashed settlement TAT to 48 hours & disputes by -82%"
      }
    ],
    "productThinking": {
      "problemCard": {
  ...
  },
  {
    ...
    "impactBadges": [
      {
        "value": "4.3 Hours",
        "label": "Pre-Auth Claim TAT (was 24h)"
      },
      {
        "value": "82%",
        "label": "Claim Approval Speedup"
      },
      {
        "value": "99.8%",
        "label": "Medication Safety Accuracy"
      }
    ],
    "tags": [
      "Healthcare AI",
    ...
    "executionJourney": [
      {
        ...
        "subtitle": "Hospital Registration & Onboarding"
      },
      {
        "step": "2",
        "icon": "📑",
        "title": "Policy Scan",
        "subtitle": "Automated ICD-10 Data Extraction"
      },
      {
        "step": "3",
        "icon": "🤖",
        "title": "AI Pre-Auth Agent",
        "subtitle": "Automated Insurance Claim Sync"
      },
      {
        "step": "4",
        "icon": "💊",
        "title": "Safety Check",
        "subtitle": "Drug Interaction & Dosage Verification"
      },
      {
        "step": "5",
        "icon": "🩺",
        "title": "ICU Support",
        "subtitle": "Sepsis Intercept & Vitals Monitor"
      },
      {
        "step": "6",
        "icon": "⚡",
        "title": "SLA Escalation",
        "subtitle": "Physician Human-in-the-Loop Guardrail"
      },
      {
        "step": "7",
        "icon": "🎉",
        "title": "Admission Cleared",
        "subtitle": "82% Pre-Auth Speedup (4.3h TAT)"
      }
    ],
    "productThinking": {
      "problemCard": {
  ...
  },
  {
    ...
    "impactBadges": [
      {
        "value": "48 Hours",
        "label": "Global Campaign TAT (was 14d)"
      },
      {
        "value": "85%",
        "label": "Time Savings"
    ...
    "executionJourney": [
      {
        ...
        "subtitle": "Analyzed global ad campaign localization bottlenecks"
      },
      {
        "step": "2",
        "icon": "🎨",
        "title": "Creative Team Interviews",
        "subtitle": "Uncovered 14-day TAT pain points with creative leads"
      },
      {
        "step": "3",
        "icon": "🤖",
        "title": "AI Model Evaluation",
        "subtitle": "Assessed Generative Fill & Inpainting models"
      },
      {
        "step": "4",
        "icon": "🔤",
        "title": "Typography Engine Design",
        "subtitle": "Architected auto-bounding box & font guardrails"
      },
      {
        "step": "5",
        "icon": "🌐",
        "title": "Cultural Localization",
        "subtitle": "Built regional preset prompts & inpainting rules"
      },
      {
        "step": "6",
        "icon": "✅",
        "title": "Brand Validation",
        "subtitle": "Enforced 98.2% font kerning & contrast compliance"
      },
      {
        "step": "7",
        "icon": "🚀",
        "title": "Business Impact",
        "subtitle": "Achieved 85% TAT reduction (14 days → 48 hours)"
      }
    ],
    "productThinking": {
      "problemCard": {
    ...
    "metrics": {
      "retentionChart": {
        "labels": [
          "Legacy Agency TAT (Days)",
          "Firefly AI Transcreate (Hours)"
        ],
        "legacyCohort": [
          14,
          2
  ...
  },
  {
    ...
    "impactBadges": [
      {
        "value": "4.2 Hours",
        "label": "MTTR (Down from 18.5h)"
      },
      {
        "value": "92%",
        "label": "Resident CSAT (up from 68%)"
      },
      {
        "value": "88%",
    ...
    "executionJourney": [
      {
        ...
        "subtitle": "Identified 18.5h MTTR as primary churn driver"
      },
      {
        "step": "2",
        "icon": "💬",
        "title": "User Interviews",
        "subtitle": "Mapped resident & hostel warden inspection delays"
      },
      {
        "step": "3",
        "icon": "📊",
        "title": "Pain Point Analysis",
        "subtitle": "Discovered vague text tickets causing 4-6h delays"
      },
      {
        "step": "4",
        "icon": "📸",
        "title": "AI Image Classification",
        "subtitle": "Engineered multimodal vision scan (0.85 cutoff)"
      },
      {
        "step": "5",
        "icon": "🛠️",
        "title": "Vendor Routing",
        "subtitle": "Automated spare part pre-selection & technician SLA"
      },
      {
        "step": "6",
        "icon": "🧪",
        "title": "Pilot Launch",
        "subtitle": "Rolled out in Gurgaon & Bengaluru hostels"
      },
      {
        "step": "7",
        "icon": "📈",
        "title": "Reduced MTTR",
        "subtitle": "Cut MTTR by 77% (18.5h → 4.2h) & boosted CSAT to 92%"
      }
    ],
    "productThinking": {
      "problemCard": {
  ...
  },
  {
    ...
    "executionJourney": [
      {
        ...
        "subtitle": "Identified 42% drop-off at KYC bank verification"
      },
      {
        "step": "2",
        "icon": "🔍",
        "title": "User Drop-off",
        "subtitle": "Found manual bank statement uploads killed conversion"
      },
      {
        "step": "3",
        "icon": "⚖️",
        "title": "Credit Risk",
        "subtitle": "Balanced NPL risk (<1.8%) with instant approval goals"
      },
      {
        "step": "4",
        "icon": "🌐",
        "title": "AA Integration",
        "subtitle": "Wired 1-Tap Account Aggregator consent datastreams"
      },
      {
        "step": "5",
        "icon": "💳",
        "title": "UPI AutoMandate",
        "subtitle": "Embedded 1-click GPay/PhonePe recurring EMI autopay"
      },
      {
        "step": "6",
        "icon": "🧪",
        "title": "A/B Testing",
        "subtitle": "Ran multivariate testing across top merchant SDKs"
      },
      {
        "step": "7",
        "icon": "📈",
        "title": "Conversion Surge",
        "subtitle": "Delivered +24.5% conversion surge & sub-2 min approval"
      }
    ],
    "productThinking": {
      "problemCard": {
    ...
    "metrics": {
      "retentionChart": {
        "labels": [
          "Baseline Funnel Drop",
          "Snapmint 1-Tap Checkout"
        ],
        "legacyCohort": [
          42,
          17.5
      ...
      "slaChart": {
        "labels": [
          "Manual KYC Time (Mins)",
          "AA Automated Approval"
        ],
        "beforeSlaHours": [
          25,
          2
