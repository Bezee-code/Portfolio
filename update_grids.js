...
if (content.includes(stanzaAnchor)) {
...
if (content.includes(orientAnchor)) {
...
if (content.includes(snapmintAnchor)) {
  content = content.replace(snapmintAnchor, snapmintGrid + '\n' + snapmintAnchor);
}

fs.writeFileSync(filePath, content, 'utf8');
console.log('Successfully injected 2x2 Product Thinking Grid into index.html');
