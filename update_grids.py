...
file_path = r"C:\Users\Souvik Ghosh\.gemini\antigravity\scratch\pm-portfolio-app\index.html"
...
# Insert firefly_grid
target_firefly = '<a href="firefly.html" class="btn btn-primary" style="background:linear-gradient(135deg, #FA26A0, #c084fc);'
content = content.replace(target_firefly, firefly_grid + target_firefly)

# Insert stanza_grid
target_stanza = '<a href="stanza.html" class="btn btn-primary" style="background:linear-gradient(135deg, #6366F1, #10B981);'
content = content.replace(target_stanza, stanza_grid + target_stanza)

# Insert orient_grid
target_orient = '<a href="orient.html" class="btn btn-primary" style="background:linear-gradient(135deg, #dc2626, #0284c7);'
content = content.replace(target_orient, orient_grid + target_orient)

# Insert snapmint_grid
target_snapmint = '<a href="snapmint.html" class="btn btn-primary" style="background:linear-gradient(135deg, #0052FF, #00F0FF);'
content = content.replace(target_snapmint, snapmint_grid + target_snapmint)

with open(file_path, "w", encoding="utf-8") as f:
    f.write(content)

print("Injected 2x2 grids successfully into index.html")
